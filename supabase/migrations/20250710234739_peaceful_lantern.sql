/*
  # Create Profiles and Core Tables Schema
...
DROP POLICY IF EXISTS "Authenticated users can view retailers" ON retailers;
...
DROP POLICY IF EXISTS "Authenticated users can view sku_mappings" ON sku_mappings;
DROP POLICY IF EXISTS "Users can manage sku_mappings" ON sku_mappings;
DROP POLICY IF EXISTS "Authenticated users can view invoice_items" ON invoice_items;
DROP POLICY IF EXISTS "Users can manage invoice_items" ON invoice_items;
DROP POLICY IF EXISTS "Authenticated users can view processing_logs" ON processing_logs;
DROP POLICY IF EXISTS "System can insert processing_logs" ON processing_logs;
DROP POLICY IF EXISTS "Admins can view webhook_logs" ON webhook_logs;
DROP POLICY IF EXISTS "System can insert webhook_logs" ON webhook_logs;
DROP POLICY IF EXISTS "Users can view own sessions" ON user_sessions;
DROP POLICY IF EXISTS "System can manage user_sessions" ON user_sessions;
